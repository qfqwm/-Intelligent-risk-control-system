<template>
  <div class="all">
    ...
    <div class="right">
      ...
      >
        <a-form-item has-feedback label="任务名称" name="checkPass" style="width: 35%">
          <a-input v-model:value="formState.checkPass" type="text" autocomplete="off" />
        </a-form-item>
        <a-form-item name="area" label="发布状态" :rules="[{ message: 'Missing area' }]" style="width: 35%">
          <a-select :options="areas" />
        </a-form-item>
        <a-form-item :wrapper-col="{ span: 14, offset: 4 }" style="display: flex; justify-content: end; width: 30%">
      ...
      <div style="display: flex; justify-content: end">
        ...
        <a-button type="primary" style="margin-left: 15px"> 新增任务 </a-button>
      </div>
      <!-- 表格区域 -->
      <a-table
        ...
        <template #bodyCell="{ column, record }">
          ...
          <template v-if="column.dataIndex === 'operation'">
            ...
            <div v-if="record.assetType == '未发布'">
              <a-button type="primary" size="small">任务测试</a-button>
...
<script lang="ts" setup>
  import TaskClassification from '@/pages/Taskment/component/TaskClassification.vue';
